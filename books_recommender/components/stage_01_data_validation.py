...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ratings = pd.read_csv(self.data_validation_config.ratings_csv_file, sep = ';', on_bad_lines='skip', engine='python', encoding='latin1')
            books = pd.read_csv(self.data_validation_config.books_csv_file, sep = ';', on_bad_lines='skip', engine='python', encoding='latin1')
